  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      setStatus({
        loading: false,
        ok: true,
        msg: "Thanks — we received your message!",
      });
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-50">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      >
                        ...
                        <span
                          className={`font-bold ${form.role === "worker" ? "text-emerald-700" : "text-slate-700"}`}
                        >
                          Worker
                        </span>
                      </label>
                      ...
                      >
                        ...
                        <span
                          className={`font-bold ${form.role === "employer" ? "text-emerald-700" : "text-slate-700"}`}
                        >
                          Employer
                        </span>
                      </label>
      ...
      <footer className="bg-white border-t border-slate-200 mt-20">
        <div className="max-w-7xl mx-auto px-6 py-8 text-center text-sm text-slate-500 font-medium">
          <p>
            © {new Date().getFullYear()} Karigar. Empowering rural workers,
...
function ContactInfoCard({ icon, label, value, gradient }) {
  return (
    <div className="flex items-start gap-4 p-4 rounded-2xl hover:bg-white transition-all duration-300">
      <div
        className={`w-12 h-12 rounded-xl bg-linear-to-br ${gradient} flex items-center justify-center shadow-lg shrink-0`}
      >
